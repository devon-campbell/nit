              ...
              {transitions((style, item) => (
                <animated.div style={{...style, textAlign: 'center'}}>
                  <>
                    ...
                    {item == 7 && <img src={quarterRestSymbol} alt="Half Note Symbol"
                                                    style={{paddingTop: '24px', width: '25%'}}/>}
                    {item == 8 && <img src={halfRestSymbol} alt="Half Note Symbol"
                                       style={{paddingTop: '24px', width: '25%'}}/>}
                    {item == 9 && <img src={wholeRestSymbol} alt="Half Note Symbol"
                                       style={{paddingTop: '24px', width: '25%'}}/>}
                    <div>
